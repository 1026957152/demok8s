...
import com.gjj.api.apidata.cebV1.CebRequestParams;
import com.gjj.api.apidata.cebV1.Cebdata;
...
import com.gjj.api.service.CEBV1ServiceImpl;
import com.gjj.api.service.HistoryServiceImpl;*/
import com.example.dm.apidata.Query;
import com.example.dm.apidata.cebV1.CebRequestParams;
import com.example.dm.apidata.cebV1.Cebdata;
...
import com.example.dm.service.CEBV1ServiceImpl;
...
@RestController
@RequestMapping(value= "/v1/ceb")
@Api
    public class CEBV1ApiController extends HistoryServiceImpl {
...
/*    @Autowired
   ...
   // @Autowired
    ...
    @Autowired
    private CEBV1ServiceImpl customerService;
    @Autowired
    ...
    @ApiImplicitParams(value = {
         //   @ApiImplicitParam(name = "X-api-key", value = "accessKey", required = true,paramType="header", dataType = "String"),
            ...
            @ApiImplicitParam(name = "wtrjgh", value = "委托人机构号", required = true, dataType = "String"),
            @ApiImplicitParam(name = "wtrxm", value = "委托人名称", required = false, dataType = "String"),
    ...
    public Cebdata 个人账户基本信息查询json(
            @Valid @RequestBody CebRequestParams ccbRequestParams,
            Authentication authentication) throws MyBusinessException {
        System.out.println(authentication.getPrincipal());
        Query query = new Query();
        ...
        return customerService.queryLoanee(authentication.getPrincipal(), request,query
                ,ccbRequestParams.getZjhm());
    }
