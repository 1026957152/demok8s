 ...
 */
public enum E_待_DW0202_公积金提取审核登记表_提取原因_WithdrawReasonEnum {
...
;
    ...
    E_待_DW0202_公积金提取审核登记表_提取原因_WithdrawReasonEnum(String statusText, String displayText, Integer id, String helpMessage) {
    ...
    public static 提取原因_WithdrawReasonEnum_银行 from(String text) {
        ...
        E_待_DW0202_公积金提取审核登记表_提取原因_WithdrawReasonEnum typeEnum = E_待_DW0202_公积金提取审核登记表_提取原因_WithdrawReasonEnum.fromString(text);
        switch (typeEnum){
            case 购房:
...
/*
    ...
    public static E_待_DW0202_公积金提取审核登记表_提取原因_WithdrawReasonEnum fromString(String text) {
        for (E_待_DW0202_公积金提取审核登记表_提取原因_WithdrawReasonEnum status : E_待_DW0202_公积金提取审核登记表_提取原因_WithdrawReasonEnum.values()) {
    ...
    public static E_待_DW0202_公积金提取审核登记表_提取原因_WithdrawReasonEnum fromInt(Integer text) {
        for (E_待_DW0202_公积金提取审核登记表_提取原因_WithdrawReasonEnum status : E_待_DW0202_公积金提取审核登记表_提取原因_WithdrawReasonEnum.values()) {
