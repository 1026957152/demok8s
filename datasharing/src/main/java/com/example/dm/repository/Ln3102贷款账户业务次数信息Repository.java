...
import com.example.dm.domain.Ln3102贷款账户业务次数信息;
import org.springframework.data.jpa.repository.JpaRepository;

/**
 * Created by zhao yuan on 01/10/2015.
 */
public interface Ln3102贷款账户业务次数信息Repository extends JpaRepository<Ln3102贷款账户业务次数信息, Integer> {
    Ln3102贷款账户业务次数信息 findByContractcode合同代码(String contractcode_合同代码);
