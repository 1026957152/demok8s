...
import com.example.dm.domain.Dp1106个人缴至信息;
import org.springframework.data.jpa.repository.JpaRepository;

/**
 * Created by zhao yuan on 01/10/2015.
 */
public interface Dp1106个人缴至信息Repository extends JpaRepository<Dp1106个人缴至信息, Integer> {
    Dp1106个人缴至信息 findByAccnum个人账号(String accnum个人账号);
