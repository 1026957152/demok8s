...
import com.example.dm.domain.Dw0202提取审批信息表;
 ...
 */
public interface Dw0202提取审批信息表Repository extends JpaRepository<Dw0202提取审批信息表, Integer> {
    List<Dw0202提取审批信息表> findByAccnum个人账号(String accnum个人账号);

    List<Dw0202提取审批信息表> findByAccnum个人账号OrderByTransdate业务发生日期Desc(String accnum个人账号);
