...
import com.example.dm.domain.Dp1301单位缴存信息变更登记簿;
 ...
 */
public interface Dp1301单位缴存信息变更登记簿Repository extends JpaRepository<Dp1301单位缴存信息变更登记簿, Integer> {
    List<Dp1301单位缴存信息变更登记簿> findByUnitaccnum单位账号(String unitaccnum单位账号);
