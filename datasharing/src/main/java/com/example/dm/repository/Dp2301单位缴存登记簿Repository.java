...
import com.example.dm.domain.Dp2301单位缴存登记簿;
 ...
 */
public interface Dp2301单位缴存登记簿Repository extends JpaRepository<Dp2301单位缴存登记簿, Integer> {
    List<Dp2301单位缴存登记簿> findByUnitaccnum单位账号(String unitaccnum单位账号);
