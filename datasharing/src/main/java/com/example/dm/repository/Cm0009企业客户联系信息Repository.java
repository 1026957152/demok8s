...
import com.example.dm.domain.Cm0009企业客户联系信息;
 ...
 */
public interface Cm0009企业客户联系信息Repository extends JpaRepository<Cm0009企业客户联系信息, Integer> {
    List<Cm0009企业客户联系信息> findByUnitcustid单位客户号(String unitcustid单位客户号);
