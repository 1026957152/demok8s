...
import com.example.dm.domain.Cm0003企业客户证件信息;
import org.springframework.data.jpa.repository.JpaRepository;

/**
 * Created by zhao yuan on 01/10/2015.
 */
public interface Cm0003企业客户证件信息Repository extends JpaRepository<Cm0003企业客户证件信息, Integer> {
    Cm0003企业客户证件信息 findByUnitcustid单位客户号(String unitcustid单位客户号);
