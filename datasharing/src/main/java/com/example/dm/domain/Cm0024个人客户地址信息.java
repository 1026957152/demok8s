...
/*  comment on table WITHRUN.CM0024 is '个人客户地址信息';

  comment on column WITHRUN.CM0024.ID is '序号';

  comment on column WITHRUN.CM0024.ADDRNUM is '地址编号';

  comment on column WITHRUN.CM0024.CUSTID is '个人客户号';

  comment on column WITHRUN.CM0024.PROVINCENAME is '省份名称';

  comment on column WITHRUN.CM0024.CITYNAME is '城市名称';

  comment on column WITHRUN.CM0024.REGIONNAME is '区域名称';

  comment on column WITHRUN.CM0024.STREETNAME is '街道名称';*/

  @Id
  @Column(name = "id")
  private long id序号;
  @Column(name = "addrnum")
  private String addrnum地址编号;
  @Column(name = "custid")
...
/*  comment on column WITHRUN.CM0024.ADDRDETAIL is '地址详情';

  comment on column WITHRUN.CM0024.POSTCODE is '邮政编码';

  comment on column WITHRUN.CM0024.ISDEFAULT is '是否默认';

  comment on column WITHRUN.CM0024.CITYCODE is '城市代码';

  comment on column WITHRUN.CM0024.MAKERINST is '经办机构';*/
...
/*  comment on column WITHRUN.CM0024.MAKERTELLER is '经办柜员';

  comment on column WITHRUN.CM0024.TRANSDATE is '业务发生日期';

  comment on column WITHRUN.CM0024.BUSINESSSEQ is '业务流水号';

  comment on column WITHRUN.CM0024.CHNL is '渠道';

  comment on column WITHRUN.CM0024.CHNLSEQ is '渠道流水号';

  comment on column WITHRUN.CM0024.CREATETIME is '创建时间';

  comment on column WITHRUN.CM0024.UPDATETIME is '最后更新时间戳';

  comment on column WITHRUN.CM0024.FREEUSECHAR1 is '备用字符1';

  comment on column WITHRUN.CM0024.TRANSSEQ is '交易流水号';*/
  ...
  public String getAddrnum地址编号() {
    return addrnum地址编号;
  }

  public void setAddrnum地址编号(String addrnum地址编号) {
    this.addrnum地址编号 = addrnum地址编号;
  }
