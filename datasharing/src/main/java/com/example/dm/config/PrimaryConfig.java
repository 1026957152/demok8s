...
@EnableJpaRepositories(
        ...
        basePackages= {"com.example.dm.repository"}) //设置Repository所在位置
public class PrimaryConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryPrimary (EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("com.example.dm.domain") //设置实体类所在位置
...
/*        spring.jpa.properties.hibernate.dialect=com.my.package.to.MyDB2Dialect
    ...
    //    properties.put("spring.jpa.properties.hibernate.dialect", "org.hibernate.dialect.DB2400Dialect");
        properties.put("spring.jpa.database", "dm");
        properties.put("spring.jpa.show-sql", "true");
        properties.put("hibernate.dialect", "org.hibernate.dialect.DmDialect");
        properties.put("hibernate.show_sql", "true");
        properties.put("hibernate.hbm2ddl.auto", "none");
        properties.put("hibernate.naming.physical", "org.hibernate.boot.model.naming.PhysicalNamingStrategyStandardImpl");

       // properties.put("spring.jpa.hibernate.naming.physical", "org.hibernate.boot.model.naming.PhysicalNamingStrategyStandardImpl");
