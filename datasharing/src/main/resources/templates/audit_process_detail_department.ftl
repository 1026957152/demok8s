    ...
    <div class="col-lg-6">
        <div class="well">
            <table class="table">
                ...
                <tr>
                    <td>名称</td>
                    <td> ${analysisTable.name!''}</td>
                </tr>
                <tr>
                    <td>编号</td>
                    <td>  ${analysisTable.no!''}</td>
                </tr>
                <tr>

                    <td>描述</td>
                    <td> ${analysisTable.desc!''}</td>
                </tr>
...
<#--                <li role="presentation" class="active"><a href="#indexes" aria-controls="coalDeals" role="tab"
                ...
                <li role="presentation" class="active"><a href="#detail" aria-controls="coalDeals" role="tab"
            ...
            <div class="tab-content">
                   ...
                   <#--                                     <#list userType as type>
                        ...
                        <table class=" table-striped" id="bussiness-table" data-url="${streamUrl}" data-toggle="table" data-classes="table table-hover"   data-method="GET"
                            ...
                            <tr>
                                ...
                                <th data-field="createBy_" >新建人</th>
                                <th data-field="modifyBy_" >修改人</th>
                ...
                <div role="tabpanel" class="tab-pane active" id="detail">
                    <div class="row col-lg-12" style="">
                        ...
                        <div id="detail_toolbar" class="" >


                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#acceptModal">接收</button>
                        ...
                        <table class=" table-striped" id="bussiness-table" data-url="${doubtUrl}" data-toggle="table" data-classes="table table-hover"   data-method="GET"
                               data-content-type="application/x-www-form-urlencoded; charset=UTF-8"
                               data-query-params-type="unlimit"
                               data-query-params="queryParams"
                               data-response-handler="handleResponse"
