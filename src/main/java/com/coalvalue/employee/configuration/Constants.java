...
public class Constants {
     ...
     * openId 用户标识
	 */
    public static  String refresh_tocken_resttemplate_url ="http://weixin-service"+"/token";
  ...
  //  public static final String HOST_WEBSITE = "http://a40c58b.ngrok.natapp.cn";
    ...
    public static final String WX_QRCODE_TYPE_CONTAINER_STATION = "container_station";
    public static final String WX_QRCODE_TYPE_WORKBENCH_CONFIGURATION = "workbench_configuration";

    public static final String WX_QRCODE_MINI_PROGRAMS = "MiniPrograms";
    ...
    public static String WX_QRCODE_TYPE_LOGIN = "login";
}
