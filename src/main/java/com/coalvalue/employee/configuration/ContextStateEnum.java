...
public enum ContextStateEnum {
    ...
    Order_create_transport_operation,

    Inventory_create_transport_operation,
    order_inventory_create_transport_operation,

    Transportation_create_shipment
    ,SCAN_DELIVER_ORDER_CREATE_DRIVER_ACCOUNT,
    Message_report_get_more_detail, CONTEXT_scene_change_product_price_waiting_get_detail,
    CONTEXT_SCENE_register_general    ,Storage_create_transport_operation,
    general_create_shipment,
    inventory_out_create_shipment,
    inventory_create_shipment,
    order_create_shipment,

    order_inventory_create_shipment,
    order_inventory_create_shipment_by_deliver,
    create_order_with_buyer,
    create_order_with_deal,

    order_detail_by_broker_deliver,
    order_detail_by_buyer,
    order_detail_by_supplier,

    create_capacity_by_order,



    order_inventory_detail_to_supplier,
    order_inventory_detail_to_supplier_deliver
    ;
