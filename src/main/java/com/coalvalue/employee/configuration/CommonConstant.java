...
public class CommonConstant {
    ...
    public static final String OPEN_ACCOUNT_REQUEST_PENDING = "Pending";
    public static final String OPEN_ACCOUNT_REQUEST_APPROVED = "Approved" ;
    ...
    public static final String SESSION_CONTEXT_openId = "SESSION_CONTEXT_open_id";

    //----------------------Entity Related Status Start-----------------
    //User Role Id
    public static final int ROLE_ID_BUYER = 40;
    public static final int ROLE_ID_BUYER_CONSIGNEE = 42;
    ...
    public static final int ROLE_ID_LOGISTICS_SALES_STAFF = 62;
    ...
    public static final String USER_TYPE_COALPIT_porter = "Coalpit_porter";
    ...
    public static final String USER_ROLE_BUYER_CONSIGNEE = "ROLE_BUYER_CONSIGNEE";
    ...
    public static final String SCENE_ADMIN_CHANGE = "admin_change";
    ...
    public static final String RESOURCCE_TYPE_Producer = "Producer";
    ...
    public static final String SHIPMENT_TYPE_TYPE_INVENTORY = "inventory";
    ...
    public static final String USER_TYPE_BUYER_CONSIGNEE = "buyer_consignee";
    ...
    public static final String USER_TYPE_LOGISTICS_Sales_Staff= "logistics_Sales_Staff";
    ...
    public static final String COMPANY_TYPE_DISTRIBUTOR = "distributor";
    //
    ...
    public static final String RESOURCCE_TYPE_equipment_camera = "equipment_camera";
    public static final String RESOURCCE_TYPE_equipment_printer = "equipment_printer";
    ...
    public static final String RESOURCCE_TYPE_STATION = "station";
    ...
    public static final String RESPONSIBLE_PERSON_PRODUCT_TYPE = "product";
...
//    public static final String CAPACITY_SUPPLY_PENDING = "pending";
    ...
    public static String CoopApplication_type_Be_distributor = "be_distributor";
    public static String CoopApplication_type_Be_purchaser = "be_purchaser";
...
/*    Checkout - The checkout has not been completed.
    ...
    public static final String QualityReport_STATUS_Invalid = "Invalid";
    public static final String QualityReport_STATUS_Valid = "Valid";
