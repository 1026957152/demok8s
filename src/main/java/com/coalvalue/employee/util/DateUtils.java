...
public class DateUtils {
    ...
    public static String getDate(Date date,String text) {
        SimpleDateFormat simple = new SimpleDateFormat(text);
        return simple.format(date.getTime());
    }
    /**
     * 距离今天多久
...
/*        System.out.println("ago：" +ago);
     ...
     * @return
     */
    public static String fromToday_short(LocalDateTime localDateTime) {
...
/*        System.out.println("ago：" +ago);
     ...
     * 2012-12-29 23:47:36
     */
    public static String getMonthAndDay(LocalDateTime date) {
        SimpleDateFormat simple = new SimpleDateFormat("MM-dd");
        if(date != null) {
            return simple.format(date);
        }
