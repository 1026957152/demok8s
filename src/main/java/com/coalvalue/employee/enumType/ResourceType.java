...
*/
    ...
    equipment_led(CommonConstant.RESOURCCE_TYPE_equipment_led, 1),

    equipment_camera(CommonConstant.RESOURCCE_TYPE_equipment_camera, 1),

    equipment_printer(CommonConstant.RESOURCCE_TYPE_equipment_printer, 1),
    SYSTEM(CommonConstant.RESOURCCE_TYPE_system, 1),
    DISTRICT(CommonConstant.RESOURCCE_TYPE_district, 1),

    ATTRIBUTE(CommonConstant.RESOURCCE_TYPE_attribute, 1),

    STATISTIC_PERFORMANCE(CommonConstant.RESOURCCE_TYPE_STATISTIC_PERFORMANCE, 1),
    QUOTATION_PLAN(CommonConstant.RESOURCCE_TYPE_QUOTATION_PLAN, 1),
    STATION(CommonConstant.RESOURCCE_TYPE_STATION, 1),
    INVENTORY_TRANSFER (CommonConstant.RESOURCCE_TYPE_INVENTORY_TRANSFER, 1),
    Producer (CommonConstant.RESOURCCE_TYPE_Producer, 1),
